...
for index, row in cpds.iterrows():
    ...
    compound = Compound(entry, name, formula, mw, smiles)
...
paths = graph.simple_weighted_shortest_path(test_cases, method='num_occur')
...
paths = graph.simple_weighted_shortest_path(pyminer_test, method='num_occur')
